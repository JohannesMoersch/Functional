...
namespace Functional.Unions.Native.Tests
{
	public class NativeUnionMatchTests
	{
		...
		{
			Functional.Native.Union<string, int> union = "test";
			var called = false;
		...
		{
			Functional.Native.Union<string, int> union = 99;
			int seen = -1;
		...
		{
			Functional.Native.Union<string, int, bool> a = "x";
			Functional.Native.Union<string, int, bool> b = 5;
			Functional.Native.Union<string, int, bool> c = false;
