...
namespace Functional
{
	...
	public static class UnionEnumerableValueExtensions
	{
		...
		public static IAsyncEnumerable<IUnionValue<TUnionDefinition>> Value<TUnionDefinition>(this Task<IEnumerable<Union<TUnionDefinition>>> source)
			where TUnionDefinition : IUnionDefinition
			=> source.AsAsyncEnumerable().Select(union => union.Value());
		...
		public static IAsyncEnumerable<IUnionValue<AdhocUnionDefinition<TOne, TTwo>>> Value<TOne, TTwo>(this Task<IEnumerable<Union<TOne, TTwo>>> source)
			=> source.AsAsyncEnumerable().Select(union => union.Value());
		...
		public static IAsyncEnumerable<IUnionValue<AdhocUnionDefinition<TOne, TTwo, TThree>>> Value<TOne, TTwo, TThree>(this Task<IEnumerable<Union<TOne, TTwo, TThree>>> source)
			=> source.AsAsyncEnumerable().Select(union => union.Value());
		...
		public static IAsyncEnumerable<IUnionValue<AdhocUnionDefinition<TOne, TTwo, TThree, TFour>>> Value<TOne, TTwo, TThree, TFour>(this Task<IEnumerable<Union<TOne, TTwo, TThree, TFour>>> source)
			=> source.AsAsyncEnumerable().Select(union => union.Value());
		...
		public static IAsyncEnumerable<IUnionValue<AdhocUnionDefinition<TOne, TTwo, TThree, TFour, TFive>>> Value<TOne, TTwo, TThree, TFour, TFive>(this Task<IEnumerable<Union<TOne, TTwo, TThree, TFour, TFive>>> source)
			=> source.AsAsyncEnumerable().Select(union => union.Value());
		...
		public static IAsyncEnumerable<IUnionValue<AdhocUnionDefinition<TOne, TTwo, TThree, TFour, TFive, TSix>>> Value<TOne, TTwo, TThree, TFour, TFive, TSix>(this Task<IEnumerable<Union<TOne, TTwo, TThree, TFour, TFive, TSix>>> source)
			=> source.AsAsyncEnumerable().Select(union => union.Value());
		...
		public static IAsyncEnumerable<IUnionValue<AdhocUnionDefinition<TOne, TTwo, TThree, TFour, TFive, TSix, TSeven>>> Value<TOne, TTwo, TThree, TFour, TFive, TSix, TSeven>(this Task<IEnumerable<Union<TOne, TTwo, TThree, TFour, TFive, TSix, TSeven>>> source)
			=> source.AsAsyncEnumerable().Select(union => union.Value());
		...
		public static IAsyncEnumerable<IUnionValue<AdhocUnionDefinition<TOne, TTwo, TThree, TFour, TFive, TSix, TSeven, TEight>>> Value<TOne, TTwo, TThree, TFour, TFive, TSix, TSeven, TEight>(this Task<IEnumerable<Union<TOne, TTwo, TThree, TFour, TFive, TSix, TSeven, TEight>>> source)
			=> source.AsAsyncEnumerable().Select(union => union.Value());
