...
public static partial class EnumerableTypeExtensions
{
	...
	public static IAsyncEnumerable<TResult> SelectAsync<TSource, TResult>(this IAsyncEnumerable<TSource> source, Func<TSource, Task<TResult>> selector)
		=> selector == null ? throw new ArgumentNullException(nameof(selector))
			: AsyncIteratorEnumerable.Create((source, selector), static (o, t) => BasicTaskAsyncIterator.Create(o.source, o, async (s, _, context) => (BasicTaskAsyncIterator.ContinuationType.Take, await context.selector.Invoke(s)), t));
	...
	public static IAsyncEnumerable<TResult> SelectAsync<TSource, TResult>(this IAsyncEnumerable<TSource> source, Func<TSource, int, Task<TResult>> selector)
		=> selector == null ? throw new ArgumentNullException(nameof(selector))
			: AsyncIteratorEnumerable.Create((source, selector), static (o, t) => BasicTaskAsyncIterator.Create(o.source, o, async (s, i, context) => (BasicTaskAsyncIterator.ContinuationType.Take, await context.selector.Invoke(s, i)), t));
