...
public static partial class EnumerableTypeExtensions
{
	...
	public static IAsyncEnumerable<TSource> Skip<TSource>(this IAsyncEnumerable<TSource> source, int count)
		=> AsyncIteratorEnumerable.Create((source, count), static (o, t) => BasicAsyncIterator.Create(o.source, o, static (s, i, context) => i >= context.count ? (BasicIteratorContinuationType.Take, s) : (BasicIteratorContinuationType.Skip, default), t));
}
